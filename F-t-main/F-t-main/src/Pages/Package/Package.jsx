...
// },2000)
  ...
  return (
    ...
    <div className="trip-kiya">
        <Heading>Mindful Retreats</Heading>
     ...
     <div className="trip-kiya">
        ...
        <Text>Need help in planning a perfect travel experience in India? We have curated several travel packages covering some of the most popular holiday destinations for you!
    ...
    <div className="trip-kiya">
        ...
        <Text>No matter whether you plan to explore the mountains and valleys with your BAE or soak in the sunshine by the beaches, Our Honeymoon Packages have got you covered!</Text>
...
<Text mt="10px">Need help in getting a perfect travel experience according to your need? We have curated several travel packages covering some of the most popular holiday destinations for you!</Text>
...
<Image src="https://cdn1.tripoto.com/media/filter/tst/img/1789711/Image/1597312306_budget.jpg" mt="10px" w={{lg:"30%",md:'100%',sm:'100%'}} borderRadius="10px"/>
 ...
 <Heading mt="30px">Discover the best tour packages on India JetSet</Heading>
 <Text mt="10px" fontSize="17px">We all need to get out of our routine and hit the road every once in a while to experience the magic of travel. We offers some of the best tour packages and customised holidays in India and abroad to help you unwind and discover the world. On offer are a range of travel destinations which are perfect for a trip with family or friends. Solo travellers can chose from a range of treks and tour packages in budget friendly destinations in India and around the world. Holiday packages on India JetSet are handpicked to cater to a variety of travel styles and requirements.</Text>
 
 <Heading mt="30px">Where should you go?</Heading>
 <Text mt="10px" fontSize="17px">Browse through hundreds of holiday packages on India JetSet for some of the best selection of destinations and activities. Go island hopping in Andaman or go skydiving in Spain. Explore the national parks of Kenya or laze along the backwaters of Kerala.
<br/>
...
Explore the world of travel with India JetSet and book yourself the adventure you've always wanted!</Text></Text>

<Heading mt="30px">How to book holidays with us?
</Heading>
<Text mt="10px" fontSize="17px">Booking holidays on India JetSet is as easy as it gets. Pick from hundreds of packages. We will then connect you with your choices of travel providers via email and/or phone. Inida JetSet partners with leading travel companies in India, like MakeMyTrip, Thomas Cook, SOTC, Yatra, to name a few, to help you plan the perfect vacation.</Text>


<Text mt="30px" fontSize="17px"> Here is the step-by-step guide to booking domestic or international packages on India JetSet.</Text>
 <Flex mt="10px"><Text fontWeight="bold" fontSize="17px">Step 1:</Text><Text ml="5px" fontSize="17px"> Click on the 'Book Holidays' button on the top right corner of any page on India JetSet.</Text>
 </Flex>
 ...
 <Heading mt="40px" fontSize="17px">Why book holidays with India JetSet?</Heading>
 <Text mt="10px" fontSize="17px" mb="150px">India JetSet travel partners provide some of the best India tour packages and International tour packages. We are passionate about travel and strive to offer experiences that matter. We have a team of experienced travellers who can help you curate & plan the ideal getaway!</Text>
<hr/>
 </div>
